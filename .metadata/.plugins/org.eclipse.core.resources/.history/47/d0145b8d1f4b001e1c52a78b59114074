...
//斜めの制御の変数
#define SENSOR_GAIN_SLANT90_P 0.6//0.099*800/170//0.081
#define SENSOR_GAIN_SLANT90_D -0.05//0.018*800/170//0.018
#define CONTROLWALL_THRESHOLD_SLANT_L 170//左壁制御の閾値110
#define CONTROLWALL_THRESHOLD_SLANT_R 170//右壁制御の閾値110
#define CONTROLWALLCUT_THRESHOLD_SLANT90_L 80//左壁制御の壁切れの閾値
#define CONTROLWALLCUT_THRESHOLD_SLANT90_R 80//右壁制御の壁切れの閾値

#define SENSOR_GAIN_SLANT45_P 0.5//0.081*800/170//0.081
#define SENSOR_GAIN_SLANT45_D -0.05//0.018*800/170//0.018
#define CONTROLWALL_THRESHOLD_SLANT45_R 210//New
#define CONTROLWALL_THRESHOLD_SLANT45_L 210//New
