...
/* Private defines -----------------------------------------------------------*/
#define MOTOR_L_CWCCW_Pin GPIO_PIN_13
#define MOTOR_L_CWCCW_GPIO_Port GPIOC
#define BLUE_R_LED_Pin GPIO_PIN_14
#define BLUE_R_LED_GPIO_Port GPIOC
#define SENSOR_LED3_Pin GPIO_PIN_15
#define SENSOR_LED3_GPIO_Port GPIOC
...
#define SENSOR_LED2_Pin GPIO_PIN_4
#define SENSOR_LED2_GPIO_Port GPIOA
...
#define MOTOR_R_ENABLE_Pin GPIO_PIN_6
#define MOTOR_R_ENABLE_GPIO_Port GPIOB
#define MOTOR_R_CWCCW_Pin GPIO_PIN_7
#define MOTOR_R_CWCCW_GPIO_Port GPIOB
#define MOTOR_L_ENABLE_Pin GPIO_PIN_9
#define MOTOR_L_ENABLE_GPIO_Port GPIOB
